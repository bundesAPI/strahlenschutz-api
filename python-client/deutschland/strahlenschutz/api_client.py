...
from deutschland.strahlenschutz import rest
...
from deutschland.strahlenschutz.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.root_get  # this is an instance of the class Endpoint
        api_instance.root_get()  # this invokes api_instance.root_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.root_get.callable or self.callable in this class
